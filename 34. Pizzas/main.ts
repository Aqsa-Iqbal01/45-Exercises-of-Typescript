...
let favtPizzas :string [] = ['Fajita','Extra cheese','Malai boti']

// • Modify your for loop to print a sentence using the name of the pizza instead of printing just the name of the pizza. For each pizza you should have one
//  line of output containing a simple statement like I like pepperoni pizza.

for(let pizza of favtPizzas) {
    console.log(pizza);
